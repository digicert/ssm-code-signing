...
<html lang="en">
  <head>
    <title>Code coverage report for build/utils/fileSystemUtils.js</title>
    <meta charset="utf-8" />
    ...
    <div class="wrapper">
      <div class="pad1">
        <h1>
          ...
          <a href="index.html">build/utils</a> fileSystemUtils.js
        </h1>
        <div class="clearfix">
...
const tempDirectory = () =&gt; os_1.default.tmpdir();
