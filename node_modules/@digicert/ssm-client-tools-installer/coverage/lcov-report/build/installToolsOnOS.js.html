...
<html lang="en">
  <head>
    <title>Code coverage report for build/installToolsOnOS.js</title>
    <meta charset="utf-8" />
    ...
    <div class="wrapper">
      <div class="pad1">
        <h1>
          ...
          <a href="index.html">build</a> installToolsOnOS.js
        </h1>
        <div class="clearfix">
...
exports.installToolsBasedOnOS = exports.OSToToolMapper = void 0;
...
<span class="cstat-no" title="statement not covered" >            break;</span>
    ...
    else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="else path not taken" >E</span>if (OS == "linux") {</span>
<span class="cstat-no" title="statement not covered" >        console.log("welcome to linux!!");</span>
<span class="cstat-no" title="statement not covered" >        return await (0, installLinuxTools_1.installLinuxTools)(installationPath, toolToBeUsed);</span>
    }
    else {
<span class="cstat-no" title="statement not covered" >        console.log("welcome to macos");</span>
<span class="cstat-no" title="statement not covered" >        return await (0, installMacTools_1.installMacTools)(installationPath, toolToBeUsed);</span>
    }
}
