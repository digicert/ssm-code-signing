...
<html lang="en">
  <head>
    <title>Code coverage report for build/installMacTools.js</title>
    <meta charset="utf-8" />
    ...
    <div class="wrapper">
      <div class="pad1">
        <h1>
          ...
          <a href="index.html">build</a> installMacTools.js
        </h1>
        <div class="clearfix">
...
//   return extractPath;
//  }
async function <span class="fstat-no" title="function not covered" >installMacTools(</span>installationPath, toolToBeUsed) {
    //   try {
