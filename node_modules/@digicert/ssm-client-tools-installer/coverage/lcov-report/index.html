    ...
    <div class="wrapper">
      <div class="pad1">
        ...
        <div class="clearfix">
          <div class="fl pad1y space-right2">
            ...
            <span class="fraction">140/176</span>
          </div>
          ...
          <div class="fl pad1y space-right2">
            ...
            <span class="fraction">134/169</span>
          </div>
        </div>
        <p class="quiet">
      ...
      <div class="pad1">
        <table class="coverage-summary">
          ...
          <tbody>
            <tr>
              <td class="file high" data-value="ssm-client-tools-installer">
                <a href="ssm-client-tools-installer/index.html"
                  >ssm-client-tools-installer</a
                >
              </td>
              <td data-value="80.88" class="pic high">
                <div class="chart">
                  <div class="cover-fill" style="width: 80%"></div>
                  <div class="cover-empty" style="width: 20%"></div>
                </div>
              </td>
              <td data-value="80.88" class="pct high">80.88%</td>
              <td data-value="136" class="abs high">110/136</td>
              ...
              <td data-value="133" class="abs high">108/133</td>
            </tr>

            <tr>
              <td
                class="file medium"
                data-value="ssm-client-tools-installer/utils"
              >
                <a href="ssm-client-tools-installer/utils/index.html"
                  >ssm-client-tools-installer/utils</a
                >
              </td>
