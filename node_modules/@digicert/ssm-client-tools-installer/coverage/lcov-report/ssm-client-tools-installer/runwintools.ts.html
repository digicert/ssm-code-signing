...
<head>
    <title>Code coverage report for ssm-client-tools-installer/runwintools.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">ssm-client-tools-installer</a> runwintools.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span></td><td class="text"><pre class="prettyprint lang-js">import fs from "fs";
import path from "path";
import { getAPICall,uiAPIPrefix } from "./utils/services";
...
module.exports={runWinToolBasedInstallationOrExtraction,getAPICall}</pre></td></tr></table></pre>
