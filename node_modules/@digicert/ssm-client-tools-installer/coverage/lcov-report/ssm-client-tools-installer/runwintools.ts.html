...
<html lang="en">
  <head>
    <title>
      Code coverage report for ssm-client-tools-installer/runwintools.ts
    </title>
    <meta charset="utf-8" />
    ...
    <div class="wrapper">
      <div class="pad1">
        <h1>
          ...
          <a href="index.html">ssm-client-tools-installer</a> runwintools.ts
        </h1>
        <div class="clearfix">
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (regReturnCode != 0) {
