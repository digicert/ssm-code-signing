...
<html lang="en">
  <head>
    <title>Code coverage report for ssm-client-tools-installer</title>
    <meta charset="utf-8" />
  ...
  <body>
    <div class="wrapper">
      <div class="pad1">
        <h1>
          <a href="../index.html">All files</a> ssm-client-tools-installer
        </h1>
        <div class="clearfix">
          ...
          <div class="fl pad1y space-right2">
            <span class="strong">81.2% </span>
            <span class="quiet">Lines</span>
            <span class="fraction">108/133</span>
          </div>
        </div>
        <p class="quiet">
      ...
      <div class="pad1">
        <table class="coverage-summary">
          ...
          <tbody>
            <tr>
              <td class="file high" data-value="OsType.ts">
                <a href="OsType.ts.html">OsType.ts</a>
              </td>
            ...
            <tr>
              <td class="file low" data-value="installLinuxTools.ts">
                <a href="installLinuxTools.ts.html">installLinuxTools.ts</a>
              </td>
              <td data-value="31.57" class="pic low">
                <div class="chart">
                  <div class="cover-fill" style="width: 31%"></div>
                  <div class="cover-empty" style="width: 69%"></div>
                </div>
              </td>
            ...
            <tr>
              <td class="file medium" data-value="installMacTools.ts">
                <a href="installMacTools.ts.html">installMacTools.ts</a>
              </td>
            ...
            <tr>
              <td class="file high" data-value="installToolsOnOS.ts">
                <a href="installToolsOnOS.ts.html">installToolsOnOS.ts</a>
              </td>
              <td data-value="100" class="pic high">
                <div class="chart">
                  <div class="cover-fill cover-full" style="width: 100%"></div>
            ...
            <tr>
              <td class="file high" data-value="installwindowsTools.ts">
                <a href="installwindowsTools.ts.html">installwindowsTools.ts</a>
              </td>
              <td data-value="100" class="pic high">
                <div class="chart">
                  <div class="cover-fill cover-full" style="width: 100%"></div>
            ...
            <tr>
              <td class="file low" data-value="runLinuxTools.ts">
                <a href="runLinuxTools.ts.html">runLinuxTools.ts</a>
              </td>
              <td data-value="26.66" class="pic low">
                <div class="chart">
                  <div class="cover-fill" style="width: 26%"></div>
                  <div class="cover-empty" style="width: 74%"></div>
                </div>
              </td>
            ...
            <tr>
              <td class="file high" data-value="runwintools.ts">
                <a href="runwintools.ts.html">runwintools.ts</a>
              </td>
