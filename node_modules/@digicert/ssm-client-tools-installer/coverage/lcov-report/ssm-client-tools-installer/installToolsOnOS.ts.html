...
<head>
    <title>Code coverage report for ssm-client-tools-installer/installToolsOnOS.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">ssm-client-tools-installer</a> installToolsOnOS.ts</h1>
        <div class='clearfix'>
...
&nbsp;
module.exports={installToolsBasedOnOS}</pre></td></tr></table></pre>
