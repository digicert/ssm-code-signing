...
<html lang="en">
  <head>
    <title>
      Code coverage report for ssm-client-tools-installer/installToolsOnOS.ts
    </title>
    <meta charset="utf-8" />
...
&nbsp;
  if (OS == "win32") {
    console.log("tooltobe used", toolToBeUsed);
    return await installWindowsTools(installationPath, toolToBeUsed, usecase);
  } else if (OS == "linux") {
    console.log("welcome to linux!!");
    return await installLinuxTools(installationPath, toolToBeUsed, usecase);
  } else {
