...
<head>
    <title>Code coverage report for ssm-client-tools-installer/installwindowsTools.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">ssm-client-tools-installer</a> installwindowsTools.ts</h1>
        <div class='clearfix'>
...
module.exports={installWindowsTools}</pre></td></tr></table></pre>
