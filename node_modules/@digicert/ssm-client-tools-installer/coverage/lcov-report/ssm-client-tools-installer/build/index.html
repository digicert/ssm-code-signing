...
<html lang="en">
  <head>
    <title>Code coverage report for ssm-client-tools-installer/build</title>
    <meta charset="utf-8" />
    ...
    <div class="wrapper">
      <div class="pad1">
        <h1>
          ...
          ssm-client-tools-installer/build
        </h1>
        <div class="clearfix">
          <div class="fl pad1y space-right2">
            <span class="strong">53.95% </span>
            <span class="quiet">Statements</span>
            <span class="fraction">116/215</span>
          </div>

          <div class="fl pad1y space-right2">
            <span class="strong">49.66% </span>
            <span class="quiet">Branches</span>
            <span class="fraction">75/151</span>
          </div>
          ...
          <div class="fl pad1y space-right2">
            <span class="strong">58.03% </span>
            <span class="quiet">Lines</span>
            <span class="fraction">112/193</span>
          </div>
        </div>
        <p class="quiet">
      ...
      <div class="pad1">
        <table class="coverage-summary">
          ...
          <tbody>
            <tr>
              <td class="file high" data-value="OsType.js">
                <a href="OsType.js.html">OsType.js</a>
              </td>
            ...
            <tr>
              <td class="file low" data-value="installLinuxTools.js">
                <a href="installLinuxTools.js.html">installLinuxTools.js</a>
              </td>
              <td data-value="34.09" class="pic low">
                <div class="chart">
                  <div class="cover-fill" style="width: 34%"></div>
                  <div class="cover-empty" style="width: 66%"></div>
                </div>
              </td>
              ...
              <td data-value="37.83" class="pct low">37.83%</td>
              <td data-value="37" class="abs low">14/37</td>
            </tr>

            <tr>
              <td class="file high" data-value="installMacTools.js">
                <a href="installMacTools.js.html">installMacTools.js</a>
              </td>
              <td data-value="100" class="pic high">
                <div class="chart">
                  <div class="cover-fill cover-full" style="width: 100%"></div>
            ...
            <tr>
              <td class="file medium" data-value="installToolsOnOS.js">
                <a href="installToolsOnOS.js.html">installToolsOnOS.js</a>
              </td>
            ...
            <tr>
              <td class="file medium" data-value="installwindowsTools.js">
                <a href="installwindowsTools.js.html">installwindowsTools.js</a>
              </td>
            ...
            <tr>
              <td class="file low" data-value="runLinuxTools.js">
                <a href="runLinuxTools.js.html">runLinuxTools.js</a>
              </td>
              <td data-value="39.13" class="pic low">
                <div class="chart">
                  <div class="cover-fill" style="width: 39%"></div>
                  <div class="cover-empty" style="width: 61%"></div>
                </div>
              </td>
            ...
            <tr>
              <td class="file medium" data-value="runwintools.js">
                <a href="runwintools.js.html">runwintools.js</a>
              </td>
              <td data-value="50.94" class="pic medium">
                <div class="chart">
