...
<html lang="en">
  <head>
    <title>
      Code coverage report for ssm-client-tools-installer/build/utils
    </title>
    <meta charset="utf-8" />
    ...
    <div class="wrapper">
      <div class="pad1">
        <h1>
          ...
          ssm-client-tools-installer/build/utils
        </h1>
        <div class="clearfix">
      ...
      <div class="pad1">
        <table class="coverage-summary">
          ...
          <tbody>
            <tr>
              <td class="file high" data-value="fileSystemUtils.js">
                <a href="fileSystemUtils.js.html">fileSystemUtils.js</a>
              </td>
            ...
            <tr>
              <td class="file medium" data-value="services.js">
                <a href="services.js.html">services.js</a>
              </td>
              <td data-value="56.36" class="pic medium">
                <div class="chart">
                  <div class="cover-fill" style="width: 56%"></div>
                  <div class="cover-empty" style="width: 44%"></div>
                </div>
              </td>
              <td data-value="56.36" class="pct medium">56.36%</td>
              <td data-value="55" class="abs medium">31/55</td>
