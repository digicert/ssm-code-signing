...
<html lang="en">
  <head>
    <title>
      Code coverage report for ssm-client-tools-installer/build/index.js
    </title>
    <meta charset="utf-8" />
    ...
    <div class="wrapper">
      <div class="pad1">
        <h1>
          ...
          <a href="index.html">ssm-client-tools-installer/build</a> index.js
        </h1>
        <div class="clearfix">
...
<span class="cstat-no" title="statement not covered" >        console.info("PKCS11 config file written in path: ", configFilePath);</span>
<span class="cstat-no" title="statement not covered" >        console.log("SSM tools setup completed");</span>
