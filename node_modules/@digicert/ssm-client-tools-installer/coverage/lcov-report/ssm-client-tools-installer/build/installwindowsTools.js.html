...
<html lang="en">
  <head>
    <title>
      ...
      ssm-client-tools-installer/build/installwindowsTools.js
    </title>
    <meta charset="utf-8" />
...
//   return extractPath;
// }
async function installWindowsTools(installationPath, toolToBeUsed) {
    try {
        fs_1.default.mkdirSync(`${installationPath}`);
    }
    catch (err) { }
    const extractPath = await (0, runwintools_1.runWinToolBasedInstallationOrExtraction)(toolToBeUsed, installationPath);
<span class="cstat-no" title="statement not covered" >    console.log("path where the ssm tools were installed/extracted is ", extractPath);</span>
    ...
    const pkcs11FileName = <span class="cstat-no" title="statement not covered" >"smpkcs11.dll";</span>
