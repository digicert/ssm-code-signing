...
<html lang="en">
  <head>
    <title>
      Code coverage report for ssm-client-tools-installer/installMacTools.ts
    </title>
    <meta charset="utf-8" />
    ...
    <div class="wrapper">
      <div class="pad1">
        <h1>
          ...
          <a href="index.html">ssm-client-tools-installer</a> installMacTools.ts
        </h1>
        <div class="clearfix">
...
//   return extractPath;
//  }
export async function <span class="fstat-no" title="function not covered" >installMacTools(</span>
