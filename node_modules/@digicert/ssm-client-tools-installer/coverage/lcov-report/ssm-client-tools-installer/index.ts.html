...
<html lang="en">
  <head>
    <title>Code coverage report for ssm-client-tools-installer/index.ts</title>
    <meta charset="utf-8" />
    ...
    <div class="wrapper">
      <div class="pad1">
        <h1>
          ...
          <a href="index.html">ssm-client-tools-installer</a> index.ts
        </h1>
        <div class="clearfix">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { tempDirectory } from "./utils/fileSystemUtils";
