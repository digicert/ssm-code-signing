...
<head>
    <title>Code coverage report for ssm-client-tools-installer/utils/fileSystemUtils.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">ssm-client-tools-installer/utils</a> fileSystemUtils.ts</h1>
        <div class='clearfix'>
