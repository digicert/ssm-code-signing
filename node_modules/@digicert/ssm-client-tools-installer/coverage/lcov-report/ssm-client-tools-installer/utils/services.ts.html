...
<html lang="en">
  <head>
    <title>
      Code coverage report for ssm-client-tools-installer/utils/services.ts
    </title>
    <meta charset="utf-8" />
    ...
    <div class="wrapper">
      <div class="pad1">
        <h1>
          ...
          <a href="index.html">ssm-client-tools-installer/utils</a> services.ts
        </h1>
        <div class="clearfix">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import axios, { AxiosRequestConfig } from "axios";
...
&nbsp;
export const getConfigFilePath = <span class="fstat-no" title="function not covered" >async </span>(
  pkcs11FileName: string,
  extractPath: string
) =&gt; {
  const configFilePath = <span class="cstat-no" title="statement not covered" >path.join(extractPath, "pkcs11properties.cfg");</span>
...
&nbsp;
  //file writing part
  const clientToolsDownloadPath = <span class="cstat-no" title="statement not covered" >path.join(</span>
    tempDirectoryPath,
    toolDownloded[toolToBeUsed]
  );
<span class="cstat-no" title="statement not covered" >  fs.writeFileSync(clientToolsDownloadPath, toolFileData);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  console.log("file after write ", fs.statSync(clientToolsDownloadPath).size);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return clientToolsDownloadPath;</span>
};
&nbsp;
module.exports = {
  getAPICall,
