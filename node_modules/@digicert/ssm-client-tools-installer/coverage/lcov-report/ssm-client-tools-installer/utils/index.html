    ...
    <div class="wrapper">
      <div class="pad1">
        <h1>
          ...
          ssm-client-tools-installer/utils
        </h1>
        <div class="clearfix">
      ...
      <div class="pad1">
        <table class="coverage-summary">
          ...
          <tbody>
            <tr>
              <td class="file high" data-value="fileSystemUtils.ts">
                <a href="fileSystemUtils.ts.html">fileSystemUtils.ts</a>
              </td>
            ...
            <tr>
              <td class="file medium" data-value="services.ts">
                <a href="services.ts.html">services.ts</a>
              </td>
