...
<head>
    <title>Code coverage report for ssm-client-tools-installer/utils</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> ssm-client-tools-installer/utils</h1>
        <div class='clearfix'>
...
<tbody><tr>
	<td class="file high" data-value="fileSystemUtils.ts"><a href="fileSystemUtils.ts.html">fileSystemUtils.ts</a></td>
...
<tr>
	<td class="file medium" data-value="services.ts"><a href="services.ts.html">services.ts</a></td>
