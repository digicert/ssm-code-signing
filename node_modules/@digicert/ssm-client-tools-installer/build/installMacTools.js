...
exports.installMacTools = exports.runMacToolBasedInstallationOrExtraction = void 0;
const toolLib = __importStar(require("azure-pipelines-tool-lib/tool"));
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
const tl = __importStar(require("azure-pipelines-task-lib/task"));
const services_1 = require("./utils/services");
async function runMacToolBasedInstallationOrExtraction(toolToBeUsed, tempDirectoryPath) {
...
async function installMacTools(installationPath, toolToBeUsed) {
    ...
    const extractPath = await runMacToolBasedInstallationOrExtraction(toolToBeUsed, installationPath);
