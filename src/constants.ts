...
export const WIN_OS_TOOL_LIST = [SIGN_TOOL_SMCTL, SIGN_TOOL_SSM_SCD, SIGN_TOOL_SIGNTOOL, SIGN_TOOL_NUGET, SIGN_TOOL_MAGE, SIGN_TOOL_JARSIGNER];
export const OTHER_OS_TOOL_LIST = [SIGN_TOOL_SMCTL, SIGN_TOOL_SSM_SCD, SIGN_TOOL_NUGET, SIGN_TOOL_MAGE];